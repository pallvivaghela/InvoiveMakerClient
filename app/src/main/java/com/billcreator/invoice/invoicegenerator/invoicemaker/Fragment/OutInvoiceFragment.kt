...
class OutInvoiceFragment : Fragment(), ModelChangeListener {
    ...
    private fun updateInvoicesFromDatabase() {
        invoices = instance!!.getUnPaidInvoices(1)
    }
    ...
    private fun initLayout() {
        ...
        invoiceMessage!!.text =
            mActivity!!.resources.getString(R.string.unpaid_invoice_message)
    }
